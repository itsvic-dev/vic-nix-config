  ...
  programs.zsh = {
    ...
    initExtra = ''
      ...
      bp-upload() {
        ...
        sudo sed -E -i "s*::v*$VERSION*g" $FOLDER/.blueprint/extensions/blueprint/public/index.html
        ...
        sudo cp $FOLDER/.blueprint/assets/logo.jpg $FOLDER/.blueprint/extensions/blueprint/assets/logo.jpg
