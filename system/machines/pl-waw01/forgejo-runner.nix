{ pkgs, config, ... }:
{
  ...
  networking.firewall.extraCommands = ''
    iptables -t nat -A POSTROUTING -s 172.17.0.0/16 -d 10.21.0.0/24 -j SNAT --to-source 10.21.0.4
    iptables -t nat -A POSTROUTING -s 172.18.0.0/16 -d 10.21.0.0/24 -j SNAT --to-source 10.21.0.4
  ...
  networking.firewall.extraStopCommands = ''
    ...
    iptables -t nat -D POSTROUTING -s 172.18.0.0/16 -d 10.21.0.0/24 -j SNAT --to-source 10.21.0.4
