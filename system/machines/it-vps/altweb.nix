      ...
      services.frr = {
        ...
        config = ''
          ...
          router bgp 65002
            ...
            neighbor 192.168.170.1 remote-as 65001
            address-family ipv4 unicast
              network 2.1.0.0/16
              neighbor 192.168.170.1 soft-reconfiguration inbound
              neighbor 192.168.170.1 distribute-list 11 in
              neighbor 192.168.170.1 distribute-list 10 out
            exit-address-family
