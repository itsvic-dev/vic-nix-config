  ...
  services.cloudflared = {
    ...
    tunnels = {
      "2e679b98-a35a-4c13-84f1-b9296bc55bb2" = {
        credentialsFile = config.sops.secrets."cloudflared/2e679b98-a35a-4c13-84f1-b9296bc55bb2".path;
        ingress = {
      ...
      "90d18543-7a60-47d1-805f-ec1ee80ea962" = {
        ...
        ingress = {
          ...
          "transmission.itsvic.dev" = "http://localhost:${toString config.services.transmission.settings.rpc-port}";
        };
        default = "http_status:404";
      };
    };
